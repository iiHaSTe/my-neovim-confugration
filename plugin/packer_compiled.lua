...
_G.packer_plugins = {
  ...
  ["moonscript-vim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/moonscript-vim",
  ...
  ["nvim-lsp-compl"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/nvim-lsp-compl",
  ...
  ["vim-moonfly-colors"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vim-moonfly-colors",
